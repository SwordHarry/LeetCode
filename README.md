...
1.设计哈希集合<br/>2.设计哈希映射<br/>

##### 哈希映射

1.两数之和<br/>2.同构字符串<br/>3.两个列表的最小索引总和<br/>4.存在重复元素②<br/>

##### 设计键

1.字母异位词分组 \*<br/>2.有效的数独 \*<br/>3.寻找重复的子树<br/>
...
1.x的平方根<br/>2.猜数字大小<br/>3.搜索旋转数组 \*<br/>
...
1.成绩排序<br/>2.约数的个数 \*<br/>3.反序输出<br/>4.手机键盘<br/>5.质因数的个数 \*<br/>6.整数拆分 \*\*<br/>7.10进制VS2进制<br/>

#### 北大

1.IWannaGoHome(BFC)<br/>2.进制转换<br/>
...
1.使用最小花费爬楼梯<br/>2.比特位计数 \*<br/>3.最小路径和<br/>4.不同的二叉搜索树 \*<br/>5.回文子串\*<br/>6.两个字符串的最小ASCII码删除和 \*<br/>7.等差数列划分 \*<br/>
8.下降最小路径和<br/>9.不同路径和<br/>10.买卖股票的最佳时机<br/>11.买卖股票的最佳时机附加手续费 \*<br/>12.完全平方数 \*<br/>13.最长对数链<br/>14.填充书架 \*\*<br/>15.最大加号标志<br/>
